...
We will set up an analysis in BEAUti using a fixed tree partition. We add a DTA partition, run BEAST and analyse the results.
...
<figure>
	<a id="fig:BEAUti1"></a>
	<img style="width:45%;" src="figures/BEAUti1.png" alt="">
	<img style="width:45%;" src="figures/BEAUti2.png" alt="">
...
> Select the file `H5N1.tree` that comes with this tutorial.

<figure>
	<a id="fig:BEAUti2"></a>
	<img style="width:45%;" src="figures/BEAUti-set-up.png" alt="">
	<img style="width:45%;" src="figures/BEAUti-partitions1.png" alt="">
	<figcaption>Figure 2: Select the Fixed Tree Analysis template.</figcaption>
</figure>
...
> Select the `File => Add DisSet up DTA locationscrete Trait` menu.
...
> Select the `Browse` button, and navigate to the `H5N1locations.dat` file.
> Select the `OK` button.

<figure>
	<a id="fig:BEAUti3"></a>
	<img style="width:45%;" sSet up DTA locationsrc="figures/BEAUti-dta-set-locations.png" alt="">
